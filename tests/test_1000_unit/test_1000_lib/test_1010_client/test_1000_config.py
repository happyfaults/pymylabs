...
def test_1000_config_manager():
    ...
    from mylabs.lib.client.config import Manager
    import mylabs_c
    ...
    assert m.base_modname == 'mylabs_c'

    from mylabs.lib.lang.namespace import Type as NSType
    from mylabs.lib.client import Context as cls
    ...
    with pytest.raises(ModuleNotFoundError):
        # trying to load mylabs_c.lib which doesn't exist
        m.loadConfig(cls, cfg)

    # test later in mylabs.client module
    #assert cls.CONFIG_TYPE is mylabs_c.Config
