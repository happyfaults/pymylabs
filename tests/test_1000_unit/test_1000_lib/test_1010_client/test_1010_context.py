...
def test_1000_factory():
    from mylabs.lib.client import Factory
    cfg = {
        'a': 1
    }
    ...
    from mylabs.lib.client.conn import Manager as ConnMgr
    from mylabs.lib.client.config import Manager as ConfigMgr
...
def test_1010_level():
    from mylabs.lib.client import Level
...
def test_1020_context():
    ...
    from mylabs.client import Interactor, Factory
